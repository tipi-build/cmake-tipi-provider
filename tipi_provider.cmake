...
macro(tipi_provide_dependency method package_name)
  ...
  if("${method}" STREQUAL "FETCHCONTENT_MAKEAVAILABLE_SERIAL")
   ...
   # ${${package_name}_SOURCE_DIR}
    ...
    execute_process(
      COMMAND $ENV{CURRENT_TIPI_BINARY} -t ${POLLY_TOOLCHAIN_TAG} -u -C ${CMAKE_BUILD_TYPE} --install restore "${ARG_GIT_REPOSITORY}" "${ARG_GIT_TAG}"  
    ...
    if(error_restoring_cache)
      ...
      if(NOT ${package_name}_POPULATED)
        ...
        execute_process(
          COMMAND $ENV{CURRENT_TIPI_BINARY} -t ${POLLY_TOOLCHAIN_TAG} -C ${CMAKE_BUILD_TYPE} -u  --install .
          WORKING_DIRECTORY ${ARG_SOURCE_DIR}
